...
<div class="relative min-w-screen min-h-screen" style="background-image: url('./img/register-bg.png'); background-size: 100%;">

<?php
include('../resources/views/header.blade.php');
?>

    <div class="px-8 py-6 mx-auto mt-12 mb-12 text-left shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3 backdrop-blur-sm border sm:rounded-md  border-gray-300" style="background-color: rgba(125,125,125,0.2);">
