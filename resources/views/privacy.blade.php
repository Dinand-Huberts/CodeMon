                ...
                <div class="wrapper-privacy" style="overflow: hidden; list-style-type: disc;">
                    ...
                    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to
                        ...
                        Policy has been created with the help of the <a
                            href="https://www.privacypolicies.com/blog/privacy-policy-template/" target="_blank">Privacy
                            Policy Template</a>.</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Codemon, accessible from <a href="codemon.test"
                                    rel="external nofollow noopener" target="_blank">codemon.test</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: codemon@gmail.com</p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="codemon.test/contact"
                                    rel="external nofollow noopener" target="_blank">codemon.test/contact</a></p>
                        </li>
                    </ul>
                </div>
            </div>
