<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-amber-500">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex md:order-2">
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-red-600 dark:hover:bg-red-600 dark:focus:ring-red-600">Get started</button> <!-- if (!$USER->loggedin()) -->
